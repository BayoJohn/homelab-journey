...
![Dpkg Lock Error](assets/27-proxmox-pve-shell-dpkg-lock-error.png)
...
![Netplan Error](assets/40-k3s-worker1-netplan-apply-interface-error.png)
...
![Alloy Image Pull Error](assets/43-k3s-control-alloy-pod-image-pull-backoff-fix.png)
...
![Gitea 503 Error](assets/47-gitea-ingress-nginx-503-service-unavailable-error.png)
